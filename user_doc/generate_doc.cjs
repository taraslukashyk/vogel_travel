...
children.push(createParagraph("Справжньою родзинкою головної сторінки є красива інтерактивна мапа світу, на якій нанесені маркери партнерів Vogel Travel. Мапа дозволяє:"));
  ...
  styles: {
    ...
    paragraphStyles: [
      ...
      },
      {
        ...
        run: { font: defaultFont, size: 26, bold: true, color: "158854" },

...
function SortableRow({ offer, onToggle, onDelete }: { offer: DBOffer; onToggle: () => void; onDelete: () => void }) {
  ...
  return (
    <tr ref={setNodeRef} style={style} className="border-b border-gray-100 hover:bg-gray-50">
      ...
      <td className="px-3 py-3 text-gray-600">{offer.location}</td>
      <td className="px-3 py-3 text-gray-600">{offer.discount}</td>
      <td className="px-3 py-3">
      ...
      <td className="px-3 py-3">
        <div className="flex gap-2">
          <Link to={`/admin/offers/${offer.id}`} className="text-teal-600 hover:text-teal-800"><Edit size={16} /></Link>

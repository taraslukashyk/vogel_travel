...
function SortableRow({ post, onToggle, onDelete }: { post: DBBlogPost; onToggle: () => void; onDelete: () => void }) {
    ...
    <tr ref={setNodeRef} style={style} className="border-b border-gray-100 hover:bg-gray-50">
      ...
      <td className="px-3 py-3">
        <div className="flex gap-2">
          <Link to={`/admin/blog/${post.id}`} className="text-teal-600 hover:text-teal-800"><Edit size={16} /></Link>

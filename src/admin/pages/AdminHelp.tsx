      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="p-4 bg-gray-50 rounded-lg md:col-span-2">
              <h3 className="font-medium text-gray-800 mb-2">Alt-текст зображень (Image Alt)</h3>
              <p className="text-sm text-gray-600">
                Текстовий опис того, що зображено на фотографії. Невидимий для звичайних користувачів, але <strong>вкрай важливий для Google</strong>. Він допомагає пошуковим системам зрозуміти суть картинки та показувати її у "Google Картинках". Якщо придумати важко — просто опишіть, що ви бачите на екрані (наприклад, "Вид на гори з балкона готелю у Буковелі").
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              <h4 className="font-medium text-gray-800">Як часто потрібно оновлювати SEO?</h4>
              <p className="text-sm text-gray-600 mt-1">Обов'язково заповнюйте SEO-поля при створенні кожної нової пропозиції чи статті. Для існуючих сторінок рекомендується проводити огляд раз на 3-6 місяців у Google Search Console. Також не забувайте підлаштовувати заголовки під актуальний сезон (наприклад, додавати "Літо 2026" або "Раннє бронювання"). Старі статті блогу корисно іноді "освіжати", щоб вони не втрачали позицій у пошуку.</p>
            </div>
          </div>
        </div>
      </div>

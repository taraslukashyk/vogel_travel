...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 w-full pointer-events-auto bg-black/40 backdrop-blur-lg border-b border-white/10">
      ...
      {/* 1. Top Utility Row (More compact) */}
      <div className="w-full h-8 border-b border-white/5 mx-auto max-w-[1440px] px-6 md:px-8 lg:px-12 flex items-center justify-between text-white/50 font-montserrat text-[10px] uppercase tracking-[0.1em]">
        
        {/* Left: Tagline */}
        <p className="hidden md:block font-script text-xs text-white/40 normal-case tracking-normal italic">
          Кожна подорож — це історія, яку ви розповідатимете роками
        </p>

        {/* Right: Contacts (Moved here) */}
        <div className="flex items-center gap-5 ml-auto">
          ...
          <a href="https://t.me/me_ppo" target="_blank" rel="noreferrer" className="flex items-center gap-1.5 hover:text-white transition-colors">
      ...
      {/* 2. Main Navigation Row (More compact height) */}
      <div className="w-full py-4 mx-auto max-w-[1440px] px-6 md:px-8 lg:px-12 flex items-center justify-between text-white font-montserrat tracking-wide font-medium relative">
        ...
        <div className="flex items-center gap-10 lg:gap-16">
          ...
          <div className="flex items-center gap-3 cursor-pointer group">
            <img src={logo} alt="Vogel Logo" className="w-10 h-10 object-contain" />
            <div className="flex flex-col uppercase leading-[0.8] text-lg md:text-xl font-black">
        ...
        {/* Center Icons (sticky look, higher up) */}
        <div className="hidden md:flex flex-col items-center gap-2 absolute left-1/2 -translate-x-1/2 top-4">
          <div className="flex items-center gap-3 border border-white/10 rounded-sm py-2 px-4 bg-white/5 backdrop-blur-md shadow-lg">

...
const Footer = () => {
  return (
    <footer className="w-full bg-[#050505] text-white pt-24 pb-12 border-t border-white/5 relative overflow-hidden font-montserrat">
            ...
            <div className="flex flex-col sm:flex-row gap-8 items-start mb-8">
              ...
              <div className="flex flex-col justify-center py-2 text-left">
                <p className="font-inter text-white/50 text-sm leading-relaxed mb-4">
                  Ексклюзивна VIP-група у WhatsApp для отримання найкращих пропозицій, преміальних готелів та трендових маршрутів по всьому світу.
                </p>

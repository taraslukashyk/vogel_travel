import{j as w}from"./index-CX1IOKgy.js";import"./vendor-react-CUfvpDno.js";const n=({src:o,alt:i,className:s,sizes:r="(max-width: 768px) 100vw, 50vw",...m})=>{const p=o.includes("images.unsplash.com");let a;if(p){const t=o.split("?")[0];a=`
